const translations = {
  en: {
    ...
    buyerNetWorth: "Buyer's {mode} net worth",
    renterNetWorth: "Renter's {mode} net worth",
    buyerPercentileNetWorth: "Buyer's 50th percentile {mode} net worth",
    renterPercentileNetWorth: "Renter's 50th percentile {mode} net worth",
    higherFinalValue: "Higher final value",
    buying: "Buying",
    renting: "Renting",
    tie: "Tie",
    confidenceDecision: "{option} with {confidence} confidence",
  ...
  es: {
    ...
    buyerNetWorth: "Patrimonio {mode} del comprador",
    renterNetWorth: "Patrimonio {mode} del inquilino",
    buyerPercentileNetWorth: "Percentil 50 del patrimonio {mode} del comprador",
    renterPercentileNetWorth: "Percentil 50 del patrimonio {mode} del inquilino",
    higherFinalValue: "Mayor valor final",
    buying: "Comprar",
    renting: "Alquilar",
    tie: "Empate",
    confidenceDecision: "{option} con un {confidence} de confianza",
